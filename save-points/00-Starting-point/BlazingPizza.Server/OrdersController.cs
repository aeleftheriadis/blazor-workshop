...
namespace BlazingPizza.Server
{
    ...
    public class OrdersController : Controller
    {
        ...
        private static async Task SendNotificationAsync(Order order, NotificationSubscription subscription, string message)
        {
            ...
            var publicKey = "BLpFvKAbL80TOT8az67FqZD9UnxjWfsx9WiMHG92ycPWPgI2WvnlUxVy0GntCed0d1KFokJf3Rg5NCHK9IM2pDY";
            var privateKey = "RGFd3b3pUMNojUJpIs7BgH3pGFrNKqiQ6bgawpDDfEQ";

            var pushSubscription = new PushSubscription(subscription.Url, subscription.P256dh, subscription.Auth);
            var vapidDetails = new VapidDetails("mailto:<athanasios.eleftheriadis@gmail.com>", publicKey, privateKey);
